...
class TestIpSchema(unittest.TestCase):
    """IpSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IpSchema:
        """Test IpSchema
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `IpSchema`
        """
        model = IpSchema()
        if include_optional:
            return IpSchema(
