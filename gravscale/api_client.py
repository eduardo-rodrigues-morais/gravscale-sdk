...
from gravscale.api_response import ApiResponse, T as ApiResponseT
import gravscale.models
from gravscale import rest
from gravscale.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gravscale.models, klass)
