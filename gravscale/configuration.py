...
class Configuration:
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = (
            "http://under-dev-services.gravmanage.com/dev/public-api"
            if host is None
            else host
        )
        """Default Base url
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("gravscale")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                "url": "http://under-dev-services.gravmanage.com/dev/public-api",
