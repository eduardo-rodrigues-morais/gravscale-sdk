...
class VirtualPrivateCloudApi:
    ...
    def list_vpc(
        ...
        _param = self._list_vpc_serialize(
            client_id=client_id,
            page=page,
            size=size,
    ...
    @validate_call
    def list_vpc_without_preload_content(
        self,
        client_id: StrictInt,
        page: Optional[Annotated[int, Field(strict=True, ge=1)]] = None,
        size: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
